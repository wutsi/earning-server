    ...
    public companion object {
        public val SECURED_ENDPOINTS: RequestMatcher =
            org.springframework.security.web.util.matcher.OrRequestMatcher(
                org.springframework.security.web.util.matcher.AntPathRequestMatcher("/v1/earnings/users/*", "GET"),
                org.springframework.security.web.util.matcher.AntPathRequestMatcher("/v1/earnings/compute", "GET"),
                org.springframework.security.web.util.matcher.AntPathRequestMatcher("/v1/earnings/replay", "GET")
            )
    }
}
